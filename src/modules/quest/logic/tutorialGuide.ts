...
const qiPillTemplate: ItemDefinition = { id: 'wanjie-core:cultivation:qi_gathering_pill', name: '聚气丹', type: '丹药' as const, rarity: '普通' as const, description: '用于辅助修炼', stackable: true, maxStack: 99, effects: [] };
const foundationPillTemplate: ItemDefinition = { id: 'wanjie-core:cultivation:foundation_pill', name: '筑基丹', type: '丹药' as const, rarity: '稀有' as const, description: '用于突破筑基境界', stackable: true, maxStack: 99, effects: [] };
...
const goldCorePillTemplate: ItemDefinition = { id: 'wanjie-core:cultivation:golden_core_pill', name: '结金丹', type: '丹药' as const, rarity: '史诗' as const, description: '用于突破金丹境界', stackable: true, maxStack: 99, effects: [] };
