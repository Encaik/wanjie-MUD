 ...
 * 新手任务系统
 *
 * @deprecated 自 2026-06 起被事件驱动的分阶段引导系统（tutorialGuide.ts + taskProgressTracker.ts）替代。
 * 此文件保留用于参考旧实现结构，不应用于新功能。
 * 如未来确认无迁移需要，可安全删除。
 *
 * 特点：
 * - 线性任务链，按顺序完成
...
const spiritStoneItems: ItemDefinition[] = [{ id: 'wanjie:common:spirit_stone', name: '灵石', type: '灵石' as const, rarity: '普通' as const, description: '修仙界的通用货币', stackable: true, maxStack: 999999, effects: [] }];
const cultivationPillItems: ItemDefinition[] = [
  { id: 'wanjie-core:cultivation:qi_gathering_pill', name: '聚气丹', type: '丹药' as const, rarity: '普通' as const, description: '用于辅助修炼', stackable: true, maxStack: 99, effects: [] },
...
const breakthroughItems: ItemDefinition[] = [
  { id: 'wanjie-core:cultivation:foundation_pill', name: '筑基丹', type: '丹药' as const, rarity: '稀有' as const, description: '用于突破筑基境界', stackable: true, maxStack: 99, effects: [] },
  { id: 'wanjie-core:cultivation:golden_core_pill', name: '结金丹', type: '丹药' as const, rarity: '史诗' as const, description: '用于突破金丹境界', stackable: true, maxStack: 99, effects: [] },
...
const restorePillItems: ItemDefinition[] = [
  { id: 'wanjie:common:rejuvenation_pill', name: '回春丹', type: '丹药' as const, rarity: '普通' as const, description: '恢复少量生命值', stackable: true, maxStack: 99, effects: [] },
