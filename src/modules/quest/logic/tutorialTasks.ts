...
const cultivationPillItems: ItemDefinition[] = [
  { id: 'wanjie:cultivation:qi_gathering_pill', name: '聚气丹', type: '丹药' as const, rarity: '普通' as const, description: '用于辅助修炼', stackable: true, maxStack: 99, effects: [] },
...
const breakthroughItems: ItemDefinition[] = [
  { id: 'wanjie:cultivation:foundation_pill', name: '筑基丹', type: '丹药' as const, rarity: '稀有' as const, description: '用于突破筑基境界', stackable: true, maxStack: 99, effects: [] },
  { id: 'wanjie:cultivation:golden_core_pill', name: '结金丹', type: '丹药' as const, rarity: '史诗' as const, description: '用于突破金丹境界', stackable: true, maxStack: 99, effects: [] },
