...
export const QUEST_TUTORIAL_POOL: RewardPool = {
  ...
  name: '新手任务奖励',
  entries: [
    { type: 'currency', currencyType: '灵石', amount: [50, 100], weight: 50 },
...
export const QUEST_DAILY_POOL: RewardPool = {
  ...
  name: '日常任务奖励',
  entries: [
    { type: 'currency', currencyType: '灵石', amount: [20, 80], weight: 50 },
...
export const QUEST_FACTION_POOL: RewardPool = {
  ...
  name: '宗门任务奖励',
  entries: [
    { type: 'currency', currencyType: '灵石', amount: [50, 200], weight: 35 },
