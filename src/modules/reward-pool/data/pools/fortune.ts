...
export const FORTUNE_SPIRIT_VEIN_COMBAT: RewardPool = {
  ...
  name: '灵矿脉战斗掉落',
  entries: [
    { type: 'currency', currencyType: '灵石', amount: [20, 80], weight: 55 },
...
export const FORTUNE_SPIRIT_VEIN_RESOURCE: RewardPool = {
  ...
  name: '灵矿脉资源采集',
  entries: [
    { type: 'currency', currencyType: '灵石', amount: [30, 150], weight: 70 },
...
export const FORTUNE_BATTLEFIELD_COMBAT: RewardPool = {
  ...
  name: '古战场战斗掉落',
  entries: [
    { type: 'currency', currencyType: '灵石', amount: [15, 60], weight: 35 },
...
export const FORTUNE_BATTLEFIELD_RESOURCE: RewardPool = {
  ...
  entries: [
    ...
    { type: 'currency', currencyType: '灵石', amount: [10, 50], weight: 25 },
  ],
  dropCount: [1, 2],
};
...
export const FORTUNE_HERB_VALLEY_COMBAT: RewardPool = {
  ...
  name: '药谷战斗掉落',
  entries: [
    { type: 'currency', currencyType: '灵石', amount: [10, 40], weight: 35 },
...
export const FORTUNE_HERB_VALLEY_RESOURCE: RewardPool = {
  ...
  entries: [
    ...
    { type: 'currency', currencyType: '灵石', amount: [5, 30], weight: 15 },
  ],
  dropCount: [1, 3],
};
...
export const FORTUNE_MYSTIC_REALM_COMBAT: RewardPool = {
  ...
  name: '秘境战斗掉落',
  entries: [
    { type: 'currency', currencyType: '灵石', amount: [25, 100], weight: 30 },
...
export const FORTUNE_MYSTIC_REALM_RESOURCE: RewardPool = {
  ...
  entries: [
    ...
    { type: 'currency', currencyType: '灵石', amount: [20, 80], weight: 25 },
  ],
  dropCount: [1, 3],
};
...
export const FORTUNE_DEMON_ABYSS_COMBAT: RewardPool = {
  ...
  name: '魔渊战斗掉落',
  entries: [
    { type: 'currency', currencyType: '灵石', amount: [50, 300], weight: 25 },
...
export const FORTUNE_DEMON_ABYSS_RESOURCE: RewardPool = {
  ...
  entries: [
    ...
    { type: 'currency', currencyType: '灵石', amount: [30, 150], weight: 15 },
  ],
  dropCount: [1, 3],
};
...
export const FORTUNE_WEAPON_ARMORY_COMBAT: RewardPool = {
  ...
  entries: [
    ...
    { type: 'currency', currencyType: '灵石', amount: [15, 60], weight: 30 },
  ],
  dropCount: [1, 2],
};
...
export const FORTUNE_TREASURY_COMBAT: RewardPool = {
  ...
  name: '金库战斗',
  entries: [
    { type: 'currency', currencyType: '灵石', amount: [50, 300], weight: 60 },
    { type: 'currency', currencyType: '灵石', amount: [300, 1000], weight: 15, conditions: [{ type: 'playerLevelMin', value: 20 }] },
...
export const FORTUNE_TREASURY_RESOURCE: RewardPool = {
  ...
  name: '金库探索',
  entries: [
    { type: 'currency', currencyType: '灵石', amount: [100, 500], weight: 70 },
    { type: 'currency', currencyType: '灵石', amount: [500, 2000], weight: 15, conditions: [{ type: 'playerLevelMin', value: 30 }] },
...
export const FORTUNE_SCRIPTORIUM_COMBAT: RewardPool = {
  ...
  entries: [
    ...
    { type: 'currency', currencyType: '灵石', amount: [15, 60], weight: 25 },
  ],
  dropCount: [1, 2],
};
...
export const FORTUNE_FORGE_COMBAT: RewardPool = {
  ...
  entries: [
    ...
    { type: 'currency', currencyType: '灵石', amount: [15, 60], weight: 40 },
  ],
  dropCount: [2, 3],
};
...
export const FORTUNE_FORGE_RESOURCE: RewardPool = {
  ...
  entries: [
    ...
    { type: 'currency', currencyType: '灵石', amount: [10, 40], weight: 10 },
  ],
  dropCount: [2, 4],
};
