...
export const DUNGEON_SHRINE_POOL: RewardPool = {
  ...
  entries: [
    ...
    { type: 'static', templateId: 'wanjie:common:spirit_stone', quantity: [50, 200], weight: 10 },
  ],
  dropCount: [1, 2],
};
...
export const DUNGEON_HIDDEN_ROOM_POOL: RewardPool = {
  ...
  entries: [
    ...
    { type: 'static', templateId: 'wanjie:common:spirit_stone', quantity: [100, 500], weight: 20 },
  ],
  dropCount: [2, 4],
};
...
export const DUNGEON_ELITE_GUARDIAN_POOL: RewardPool = {
  ...
  entries: [
    ...
    { type: 'static', templateId: 'wanjie:common:spirit_stone', quantity: [50, 200], weight: 25 },
  ],
  dropCount: [2, 3],
};
