...
export function expandDarkTheme(core: ThemeCoreColors): Record<string, string> {
  ...
  return {
    '--background': core.background,
    '--foreground': core.foreground,
    '--card': `oklch(0.88 0.05 ${bgHue})`,
    '--card-foreground': core.foreground,
    '--popover': `oklch(0.93 0.04 ${bgHue})`,
    '--popover-foreground': core.foreground,
    '--primary': core.primary,
    '--primary-foreground': core.primaryForeground,
    '--secondary': `oklch(0.85 0.04 ${hue})`,
    '--secondary-foreground': `oklch(0.28 0.04 ${hue})`,
    '--muted': `oklch(0.86 0.035 ${bgHue})`,
    '--muted-foreground': `oklch(0.42 0.035 ${hue})`,
    '--accent': core.accent,
    '--accent-foreground': `oklch(0.25 0.05 ${hue})`,
    '--border': core.border,
    '--input': `oklch(0.86 0.035 ${bgHue})`,
    '--ring': core.ring,
  };
}
