...
import { getEnemyTierFromCellType, getEnemyTierConfig } from '@/modules/identity/data/worldData';
import { 
  generateAdventureGrid, 
  handleCellEvent,
  parseEnemyInfo,
} from '@/modules/exploration/logic/adventure/adventure';
...
} from '@/modules/exploration/logic/adventure/adventureStamina';
