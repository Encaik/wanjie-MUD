    ...
    <div className="flex flex-col gap-1.5">
      ...
      <div className="flex flex-col gap-1.5 sm:hidden">
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="text-[10px] font-medium tabular-nums w-12 text-right shrink-0">{protagonist.currentHp}/{protagonist.maxHp}</span>
          ...
          <span className="text-[10px] font-medium tabular-nums w-12 text-right shrink-0">{protagonist.currentMp}/{protagonist.maxMp}</span>
        </div>
        
        {/* 第三行：经验/流派/心境 条 */}
        <div className="flex items-center gap-2">
          <span className="text-[10px] font-bold text-primary shrink-0">EXP</span>
          <div className="h-1.5 flex-1 bg-muted rounded-full overflow-hidden">
            <div className="h-full bg-gradient-to-r from-primary to-primary/80 rounded-full" style={{ width: `${expPercent}%` }} />
          </div>
          <span className="text-[10px] font-medium tabular-nums w-10 text-right shrink-0">{expPercent}%</span>
          ...
          {cultivationPath && (
            <>
              ...
              <span className="text-[10px] font-medium w-8 shrink-0">Lv.{pathLevel}</span>
            </>
          )}
      ...
      <div className="hidden sm:flex items-stretch gap-4 md:gap-6">
        ...
        <div className="flex items-center shrink-0">
          <div className="flex items-center gap-2 px-3 md:px-4 py-2 rounded-sm bg-gradient-to-br from-cyan-500/10 to-cyan-600/5 border-[1.5px] border-cyan-500/30 -rotate-[0.5deg]">
            <Gem className="w-4 h-4 md:w-5 md:h-5 text-cyan-500" />
            <div className="flex flex-col">
              <span className="text-[10px] text-cyan-600 dark:text-cyan-400 font-medium font-serif tracking-wider">{currencyName}</span>
